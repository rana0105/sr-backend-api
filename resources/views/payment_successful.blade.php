        ...
        <tr>
            <td style="padding: 5px 20px;">
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            <p class="desktop-view" style="margin: 10px 0 0px 35px;font-size: 12px; font-weight: 600; color: #333333; font-family: 'Montserrat', sans-serif;text-align: right; "></p>
        ...
        <tr>
            <td style="padding:0;">
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            <p class="desktop-view" style="font-size: 24px; font-weight: 700; color: #6C3A97;line-height: 32px;text-align: center;font-family: 'Montserrat', sans-serif; ">Payment Successful!</p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;line-height: 25px;text-align: center;font-family: 'Montserrat', sans-serif;">Thank you for choosing us. We wish you happy and safe journey.</p>
                ...
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            ...
                            <p style="font-size: 14px; font-weight: 400; color: #333333;line-height: 25px;text-align: center;font-family: 'Montserrat', sans-serif;">Tropical Molla (level 9 & 10),15/1-15/4, Bir Uttam Rafiqul Islam Ave,
