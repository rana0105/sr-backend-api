        ...
        <tr>
            <td style="padding:0;">
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            <p class="desktop-view" style="font-size: 24px; font-weight: 500; color: #000;line-height: 32px; font-family: 'Montserrat', sans-serif;">Thanks for your rental request</p>
                            ...
                            <p style="font-size: 16px; font-weight: 400; color: #333333;line-height: 32px;font-family: 'Montserrat', sans-serif;">Thanks for choosing Shuttle Rental for your trip. However, since you proceeded with the Pay later option, your booking request is still pending.<b> To confirm your booking please complete your payment or pay a minimum amount. </b>If you have any query, you can always reach out to our team at 09638888868.</p>
