                ...
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            ...
                            <p style="margin: 10px 0 0px 35px;font-size: 12px; font-weight: 600; color: #333333; text-align: right;font-family: 'Montserrat', sans-serif; ">Booking ID: SB-{{$details['id']}}</p>
                ...
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            ...
                            <p style="font-size: 16px; font-weight: 400; color: #333333;line-height: 32px;font-family: 'Montserrat', sans-serif;">Dear Concern ,<br>

                                The following customer has made a booking request but has not made any payment. Please contact the customer.
                            </p>
                                        ...
                                        <table class="content" style="border-spacing:0;">
                                            <tr>
                                                <td style="padding:0;">
                                                    ...
                                                    <p style="margin: 0;font-weight: 400; font-size: 16px; color: #333333;text-align: left;line-height: 24px;font-family: 'Montserrat', sans-serif;">Email: {{$details['user']['email'] ?? ''}}</p>
