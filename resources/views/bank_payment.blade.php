...
<body style="margin:50px 0;background-color:#f9f9f9;">
        ...
        <tr>
            <td style="padding: 5px 20px;">
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            <p class="desktop-view" style="margin: 10px 0 0px 35px;font-size: 12px; font-weight: 600; color: #333333; text-align: right; ">{{\Carbon\Carbon::now()->format('d/m/Y')}}</p>
                            <p style="margin: 10px 0 0px 35px;font-size: 12px; font-weight: 600; color: #333333; text-align: right; ">Booking ID: SRB-{{$details['booking']['id']}}</p>
        ...
        <tr>
            <td style="padding:0;">
                <table width="100%" style="border-spacing:0;max-width: 600px; margin: 0 auto;">
                    <tr>
                        <td style="padding:0; ">
                            @if($details['booking']['paid_amount']<1)
                            ...
                            @endif
                            <p style="font-size: 16px; font-weight: 600; color: #000;line-height: 24px;font-family: 'Montserrat', sans-serif;">Payment Information</p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;font-family: 'Montserrat', sans-serif;">Account Name: <b>{{$details['bank']['account_name']}}</b></p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;font-family: 'Montserrat', sans-serif;">Account Number: <b>{{$details['bank']['account_number']}}</b></p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;font-family: 'Montserrat', sans-serif;">Routing Number: <b>{{$details['bank']['routing_number']}}</b></p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;font-family: 'Montserrat', sans-serif;">Bank Name: <b>{{$details['bank']['bank_name']}}</b></p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;font-family: 'Montserrat', sans-serif;">Branch Name: <b>{{$details['bank']['branch_name']}}</b></p>
                            <p style="font-size: 16px; font-weight: 400; color: #333333;line-height: 24px;text-align: center;font-family: 'Montserrat', sans-serif;">Tropical Molla (level 9 & 10),15/1-15/4, Bir Uttam Rafiqul Islam Ave,
