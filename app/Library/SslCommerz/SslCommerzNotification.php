...
//                    }
    ...
    {
        $this->successUrl = url('/api/v1/') . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = url('/api/v1/') . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = url('/api/v1/') . $this->config['cancel_url'];
    }
    ...
    public function setRequiredInfo(array $info)
    {
         ...
         * */
        $this->data['ipn_url'] = (isset($info['ipn_url'])) ? $info['ipn_url'] : $this->config['ipn_url'];
